    ...
    <>
      <div className="flex w-11/12 justify-center rounded  bg-gray-100 pt-2 pr-2 pl-1 dark:bg-gray-900 ">
        ...
        <div className="shrink pr-4 ">
          <button className="hover:bg-grey-200 h-10 rounded border border-gray-500 bg-transparent  px-4 pt-2 pb-8 font-semibold text-gray-700 hover:border-blue-700 hover:text-blue-700 dark:border-white dark:bg-gray-900 dark:text-white dark:hover:border-blue-200 dark:hover:text-blue-200">
            Search
          </button>
        </div>
      </div>
